...
from src.hdf5objects.datasets import RegionReferenceDataset


# Definitions #
# Classes #
# Module Implementation
class RegionReferenceDatasetTest(RegionReferenceDataset):
    """Implementation of MultiTypeDataset."""
...
class RegionReferenceDatasetTestFileMap(BaseHDF5Map):
    """The map for the file which implements MultiTypeDataset."""
    default_map_names: Mapping[str, str] = {"test_dataset": "test_dataset"}
    default_maps: Mapping[str, HDF5Map] = {
        "main_dataset": DatasetMap(type_=RegionReferenceDatasetTest, shape=(1,), maxshape=(None,)),
    }


class RegionReferenceDatasetTestHDF5(BaseHDF5):
    """The file object that implements the MultiTypeDataset."""
